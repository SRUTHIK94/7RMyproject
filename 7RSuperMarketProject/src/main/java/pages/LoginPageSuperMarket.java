...
public class LoginPageSuperMarket {
	...
	public LoginPageSuperMarket enterUsernameAndPassword(String usernamefield, String passwordfield)// page chaining in
																									// Login
	{
	...
	{
		wait.elementToBeClicked(driver, signin);// object wait used to call elementtobeclicked methodfrom waitutility
												// page
		signin.click();
