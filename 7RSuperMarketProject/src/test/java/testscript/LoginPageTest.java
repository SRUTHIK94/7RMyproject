...
public class LoginPageTest extends Base {
	HomePageSuperMarket homepage;// globally homepagesupermarket created for page chaining with variable name
									// homepage
	...
	public void verifyInValidUsernameAndValidPassword(String username, String password)// parameters only passes through
																						// xml
	{
